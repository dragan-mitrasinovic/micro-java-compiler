...
public class sym_old {
	...
	public static final int LEFT_PARENTHESES = 43;
	public static final int RIGHT_PARENTHESES = 44;
	public static final int LEFT_BRACKETS = 45;
	public static final int RIGHT_BRACKETS = 46;
