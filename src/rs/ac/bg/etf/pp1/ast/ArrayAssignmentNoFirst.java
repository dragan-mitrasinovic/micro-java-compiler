...
public class ArrayAssignmentNoFirst extends DesignatorStatement {

    private ArrayAssignmentList ArrayAssignmentList;
    private Designator Designator;

    public ArrayAssignmentNoFirst (ArrayAssignmentList ArrayAssignmentList, Designator Designator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ArrayAssignmentNoFirst(\n");
